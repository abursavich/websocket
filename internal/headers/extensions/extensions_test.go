...
func TestParse(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			headers: []string{"foo? bar; baz=2"}, // want comma separator
			err:     true,
		},
	}
